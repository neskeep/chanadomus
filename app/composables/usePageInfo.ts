...
const PAGE_MAP: Record<string, PageInfo> = {
  ...
  '/admin/proveedores': { title: 'Proveedores y servicios', description: 'Directorio de servicios contratados' },
  '/admin/proveedores/crear': { title: 'Nuevo Proveedor', description: 'Agrega un proveedor al directorio', breadcrumbs: [{ label: 'Proveedores y servicios', to: '/admin/proveedores' }] },
  ...
  '/admin/membresia': { title: 'Membresías', description: 'Cobro mensual de ChanaDomus por unidad' },
  '/admin/membresia/tarifas': { title: 'Tarifas de membresía', description: 'Programa una tarifa nueva y consulta el historial', breadcrumbs: [{ label: 'Membresías', to: '/admin/membresia' }] },
  ...
  '/mi-chana/proveedores': { title: 'Proveedores y servicios', description: 'Servicios recomendados' },
...
const DYNAMIC_ROUTES: Array<{ prefix: string; info: PageInfo }> = [
  ...
  { prefix: '/mi-chana/proveedores/', info: { title: 'Detalle de Proveedor', description: 'Información y reseñas', breadcrumbs: [{ label: 'Proveedores y servicios', to: '/mi-chana/proveedores' }] } },
  ...
  { prefix: '/admin/proveedores/', info: { title: 'Detalle de Proveedor', description: 'Información del proveedor', breadcrumbs: [{ label: 'Proveedores y servicios', to: '/admin/proveedores' }] } },
  ...
  { prefix: '/admin/membresia/', info: { title: 'Cierre del mes', description: 'Tarifa de cada unidad guardada al cerrar el mes', breadcrumbs: [{ label: 'Membresías', to: '/admin/membresia?tab=cierres' }] } },
