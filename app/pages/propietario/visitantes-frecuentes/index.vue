...
<template>
  <div>
    ...
    <TopbarMobileAction>
      <Button size="icon" variant="ghost" class="size-9" @click="navigateTo('/propietario/visitantes-frecuentes/nuevo')">
        <Plus class="size-4" />
      </Button>
    </TopbarMobileAction>
    ...
    <EmptyState
      ...
      description="Agrega personas que te visitan regularmente para crear pases mas rapido"
    >
      <template #action>
        <Button @click="navigateTo('/propietario/visitantes-frecuentes/nuevo')">
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Se eliminara a <span class="font-medium">{{ deletingVisitor?.visitorName }}</span> de tu directorio de visitantes frecuentes. Esta accion no se puede deshacer.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
