  ...
  <div>
    ...
    <div v-else>
          ...
          <TableBody>
            ...
            >
              ...
              <TableCell class="max-w-[200px]">
                <NuxtLink :to="`/conserje/incidencias/${item.id}`" class="truncate font-medium text-primary underline-offset-2 hover:underline">
                  {{ item.title }}
                </NuxtLink>
              </TableCell>
      ...
      <div class="space-y-2 md:hidden">
        <NuxtLink v-for="item in filteredIncidents" :key="item.id" :to="`/conserje/incidencias/${item.id}`">
