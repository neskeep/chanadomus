...
const statCards = computed(() => [
  ...
  { label: 'Proveedores', value: stats.value?.activeProviders ?? 0, icon: Wrench, color: 'emerald' },
  { label: 'Reuniones Proximas', value: stats.value?.upcomingMeetings ?? 0, icon: Calendar, color: 'purple' },
])
