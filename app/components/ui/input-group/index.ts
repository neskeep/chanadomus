...
export const inputGroupAddonVariants = cva(
  'text-muted-foreground **:data-[slot=kbd]:bg-muted-foreground/10 h-auto gap-2 py-2 text-sm font-medium group-data-[disabled=true]/input-group:opacity-50 **:data-[slot=kbd]:rounded-lg **:data-[slot=kbd]:px-1.5 [&>svg:not([class*=size-])]:size-4 flex cursor-text items-center justify-center select-none',
  {
    variants: {
      align: {
...
export const inputGroupButtonVariants = cva(
  'gap-2 rounded-lg text-sm flex items-center shadow-none',
  {
    variants: {
      size: {
