# /fix — Diagnostico y fix minimo

Diagnostica el problema, identifica root cause, aplica fix minimo, y verifica.
...
Si la verificacion falla → **volver a Fase 1 DIAGNOSE**. No parchar encima del parche.
...
- **No crear problemas nuevos** — Si el fix introduce hydration errors o rompe build, no esta terminado
